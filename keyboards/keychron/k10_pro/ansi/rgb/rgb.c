...
// Default Color of Per Key RGB (Keychron Factory Colors)
#define DC_RED {HSV_RED}
#define DC_BLU {HSV_BLUE}
#define DC_YLW {HSV_YELLOW}

const uint8_t default_per_key_led[RGB_MATRIX_LED_COUNT][3] = {
    // Row 0: Esc (Red), Function keys & Nav cluster (Yellow) - 20 LEDs
    ...
    // Row 1: Tilde (Yellow), Numbers 1-0 (Blue), Backspace & Numpad top (Yellow) - 21 LEDs
    DC_YLW, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW,

    // Row 2: Tab (Yellow), QWERTY alphas (Blue), Brackets & Numpad (Yellow) - 21 LEDs
    DC_YLW, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW,

    // Row 3: CapsLock (Yellow), ASDF alphas (Blue), Enter (Red), Numpad (Yellow) - 16 LEDs
    DC_YLW, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_RED, DC_YLW, DC_YLW, DC_YLW,

    // Row 4: LShift (Yellow), ZXCV alphas (Blue), RShift, Arrows & Numpad (Yellow) - 17 LEDs
    DC_YLW, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_BLU, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW,

    // Row 5: Modifiers (Yellow), Spacebar (Blue), Arrows & Numpad (Yellow) - 13 LEDs
    DC_YLW, DC_YLW, DC_YLW, DC_BLU, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW, DC_YLW
};

// Default mixed RGB region layout descriptor (108 entries)
