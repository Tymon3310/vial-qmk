...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_jis_91(
        ...
        BL_TOGG,  BL_STEP,  BL_UP,    _______,  _______,  BL_SPI,   _______,  _______,  _______,  _______,  _______,  _______,  _______,                      _______,  _______,  _______,
        _______,  _______,  BL_DOWN,  _______,  _______,  BL_SPD,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    ...
    [WIN_BASE] = LAYOUT_jis_91(
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_BSLS,  KC_ENT,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_INT1,  KC_RSFT,                      KC_UP,
        KC_LCTL,  KC_LGUI,  KC_LALT,  KC_INT5,                      KC_SPC,                       KC_INT4,  KC_RALT,  KC_RGUI,  FN_WIN,   KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT),
