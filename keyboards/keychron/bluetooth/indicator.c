/* Copyright 2021 ~ 2025 @ lokher (https://www.keychron.com)
 *
...
static uint8_t host_led_matrix_list[HOST_DEVICES_COUNT] = BT_INDCATION_LED_MATRIX_LIST;
#    endif
#endif

#ifdef BT_INDICATION_LED_PIN_LIST
static pin_t bt_led_pin_list[HOST_DEVICES_COUNT] = BT_INDICATION_LED_PIN_LIST;
#endif
