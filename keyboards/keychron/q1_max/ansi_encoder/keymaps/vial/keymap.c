...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [LAYER_2]  = {ENCODER_CCW_CW(KC_NO, KC_NO)},
    [LAYER_3]  = {ENCODER_CCW_CW(KC_NO, KC_NO)},
    [LAYER_4]  = {ENCODER_CCW_CW(KC_NO, KC_NO)},
    [LAYER_5]  = {ENCODER_CCW_CW(KC_NO, KC_NO)},
    [LAYER_6]  = {ENCODER_CCW_CW(KC_NO, KC_NO)},
    [LAYER_7]  = {ENCODER_CCW_CW(KC_NO, KC_NO)},
};
