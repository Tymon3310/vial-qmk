...
#define EECONFIG_SIZE_CUSTOM_RGB (OS_INDICATOR_CONFIG_SIZE + RETAIL_DEMO_SIZE + PER_KEY_RGB_TYPE_SIZE + PER_KEY_RGB_LED_COLOR_LIST_SIZE + MIX_RGB_LAYER_FLAG_SIZE + EFFECT_LIST_SIZE)
